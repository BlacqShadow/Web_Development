    ...
    <div id="wrap">
           ...
           <div class="header">
            ...
            <div id="menu">
                ...
                <li class="selected"><a href="category.html">flowers</a></li>
               ...
               <div class="new_products">
                 <xsl:for-each select="PLANT">
                   <div class="new_prod_box">
                       <a href="details.html"><xsl:value-of select="NAME/COMMON"/></a>
                       <div class="new_prod_bg">
                       <!--<span class="new_icon"><img src="images/new_icon.gif" alt="" title="" /></span> -->
                       <a href="details.html"><img src="{PHOTO}" alt="" title="" class="thumb" border="0" max-width="100%" max-height="100%" /></a>
                       </div>
                   </div>
                 </xsl:for-each>
                        <!--<div class="new_prod_box">
